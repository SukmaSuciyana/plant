...
# Konfigurasi halaman
st.set_page_config(
    page_title="AgriScan - Plant Disease Classifier",
    page_icon="🌿",
    layout="wide",
...
def load_model():
    ...
    if not saved_model_path.exists():
        saved_model_path = Path(r"D:\Download\plantvilage-sev\saved_model")
...
st.markdown("""
    <div style="text-align: center; color: #666; padding: 20px;">
        <p>🌿 AgriScan - Powered by Deep Learning | MobileNetV2 Architecture</p>
        <p style="font-size: 0.9em;">Helping farmers detect plant diseases early</p>
    </div>
""", unsafe_allow_html=True)
